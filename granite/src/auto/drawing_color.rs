...
impl DrawingColor {
    ...
    pub fn new(R: f64, G: f64, B: f64, A: f64) -> DrawingColor {
        ...
        unsafe {
            from_glib_full(ffi::granite_drawing_color_new(R, G, B, A))
        }
    }
    ...
    pub fn from_rgba(color: &mut gdk::RGBA) -> DrawingColor {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_full(ffi::granite_drawing_color_new_from_rgba(color.to_glib_none_mut().0))
        }
    }
    ...
    pub fn from_string(color: &str) -> DrawingColor {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_full(ffi::granite_drawing_color_new_from_string(color.to_glib_none().0))
        }
    }
    ...
    pub fn from_int(color: i32) -> DrawingColor {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_full(ffi::granite_drawing_color_new_from_int(color))
        }
    }
    ...
    pub fn alpha_from_int(color: i32) -> u8 {
        assert_initialized_main_thread!();
        unsafe {
            ffi::granite_drawing_color_alpha_from_int(color)
        }
    }
    ...
    pub fn red_from_int(color: i32) -> u8 {
        assert_initialized_main_thread!();
        unsafe {
            ffi::granite_drawing_color_red_from_int(color)
        }
    }
    ...
    pub fn green_from_int(color: i32) -> u8 {
        assert_initialized_main_thread!();
        unsafe {
            ffi::granite_drawing_color_green_from_int(color)
        }
    }
    ...
    pub fn blue_from_int(color: i32) -> u8 {
        assert_initialized_main_thread!();
        unsafe {
            ffi::granite_drawing_color_blue_from_int(color)
        }
    }
}
...
impl<O: IsA<DrawingColor>> DrawingColorExt for O {
    fn set_hue(&self, hue: f64) -> Option<DrawingColor> {
        unsafe {
            from_glib_full(ffi::granite_drawing_color_set_hue(self.as_ref().to_glib_none().0, hue))
        }
    }

    fn set_sat(&self, sat: f64) -> Option<DrawingColor> {
        unsafe {
            from_glib_full(ffi::granite_drawing_color_set_sat(self.as_ref().to_glib_none().0, sat))
        }
    }

    fn set_val(&self, val: f64) -> Option<DrawingColor> {
        unsafe {
            from_glib_full(ffi::granite_drawing_color_set_val(self.as_ref().to_glib_none().0, val))
        }
    }

    fn set_alpha(&self, alpha: f64) -> Option<DrawingColor> {
        unsafe {
            from_glib_full(ffi::granite_drawing_color_set_alpha(self.as_ref().to_glib_none().0, alpha))
        }
    }

    fn hue(&self) -> f64 {
        unsafe {
            ffi::granite_drawing_color_get_hue(self.as_ref().to_glib_none().0)
        }
    }

    fn sat(&self) -> f64 {
        unsafe {
            ffi::granite_drawing_color_get_sat(self.as_ref().to_glib_none().0)
        }
    }

    fn val(&self) -> f64 {
        unsafe {
            ffi::granite_drawing_color_get_val(self.as_ref().to_glib_none().0)
        }
    }

    fn add_hue(&self, val: f64) -> Option<DrawingColor> {
        unsafe {
            from_glib_full(ffi::granite_drawing_color_add_hue(self.as_ref().to_glib_none().0, val))
        }
    }

    fn set_min_sat(&self, sat: f64) -> Option<DrawingColor> {
        unsafe {
            from_glib_full(ffi::granite_drawing_color_set_min_sat(self.as_ref().to_glib_none().0, sat))
        }
    }

    fn set_min_value(&self, val: f64) -> Option<DrawingColor> {
        unsafe {
            from_glib_full(ffi::granite_drawing_color_set_min_value(self.as_ref().to_glib_none().0, val))
        }
    }

    fn set_max_sat(&self, sat: f64) -> Option<DrawingColor> {
        unsafe {
            from_glib_full(ffi::granite_drawing_color_set_max_sat(self.as_ref().to_glib_none().0, sat))
        }
    }

    fn set_max_val(&self, val: f64) -> Option<DrawingColor> {
        unsafe {
            from_glib_full(ffi::granite_drawing_color_set_max_val(self.as_ref().to_glib_none().0, val))
        }
    }

    fn multiply_sat(&self, amount: f64) -> Option<DrawingColor> {
        unsafe {
            from_glib_full(ffi::granite_drawing_color_multiply_sat(self.as_ref().to_glib_none().0, amount))
        }
    }

    fn brighten_val(&self, amount: f64) -> Option<DrawingColor> {
        unsafe {
            from_glib_full(ffi::granite_drawing_color_brighten_val(self.as_ref().to_glib_none().0, amount))
        }
    }

    fn darken_val(&self, amount: f64) -> Option<DrawingColor> {
        unsafe {
            from_glib_full(ffi::granite_drawing_color_darken_val(self.as_ref().to_glib_none().0, amount))
        }
    }

    fn darken_by_sat(&self, amount: f64) -> Option<DrawingColor> {
        unsafe {
            from_glib_full(ffi::granite_drawing_color_darken_by_sat(self.as_ref().to_glib_none().0, amount))
        }
    }

    fn to_str(&self) -> glib::GString {
        unsafe {
            from_glib_full(ffi::granite_drawing_color_to_string(self.as_ref().to_glib_none().0))
        }
    }

    fn to_int(&self) -> i32 {
        unsafe {
            ffi::granite_drawing_color_to_int(self.as_ref().to_glib_none().0)
        }
    }
}
