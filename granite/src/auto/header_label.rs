...
glib::wrapper! {
    #[doc(alias = "GraniteHeaderLabel")]
    pub struct HeaderLabel(Object<ffi::GraniteHeaderLabel, ffi::GraniteHeaderLabelClass>) @extends gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;

    match fn {
        type_ => || ffi::granite_header_label_get_type(),
    }
}

impl HeaderLabel {
        pub const NONE: Option<&'static HeaderLabel> = None;
    ...
    pub fn new(label: &str) -> HeaderLabel {
        ...
        unsafe {
            ...
            /// Creates a new builder-pattern struct instance to construct [`HeaderLabel`] objects.
            ///
            /// This method returns an instance of [`HeaderLabelBuilder`](crate::builders::HeaderLabelBuilder) which can be used to create [`HeaderLabel`] objects.
            pub fn builder() -> HeaderLabelBuilder {
                HeaderLabelBuilder::new()
            }
        
}

impl Default for HeaderLabel {
                     fn default() -> Self {
...
// rustdoc-stripper-ignore-next
        /// A [builder-pattern] type to construct [`HeaderLabel`] objects.
        ///
        /// [builder-pattern]: https://doc.rust-lang.org/1.0.0/style/ownership/builders.html
#[must_use = "The builder must be built to be used"]
pub struct HeaderLabelBuilder {
            builder: glib::object::ObjectBuilder<'static, HeaderLabel>,
        }

        impl HeaderLabelBuilder {
        fn new() -> Self {
...
pub trait HeaderLabelExt: 'static {
...
impl<O: IsA<HeaderLabel>> HeaderLabelExt for O {
    fn label(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_header_label_get_label(self.as_ref().to_glib_none().0))
        }
    }

    fn set_label(&self, value: &str) {
        unsafe {
            ffi::granite_header_label_set_label(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn connect_label_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_label_trampoline<P: IsA<HeaderLabel>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteHeaderLabel, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
