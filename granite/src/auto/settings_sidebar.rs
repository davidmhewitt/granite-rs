...
impl SettingsSidebar {
    ...
    pub fn new(stack: &gtk::Stack) -> SettingsSidebar {
        ...
        unsafe {
            from_glib_none(ffi::granite_settings_sidebar_new(stack.to_glib_none().0))
        }
    }
...
impl<O: IsA<SettingsSidebar>> SettingsSidebarExt for O {
    fn stack(&self) -> Option<gtk::Stack> {
        unsafe {
            from_glib_none(ffi::granite_settings_sidebar_get_stack(self.as_ref().to_glib_none().0))
        }
    }

    fn visible_child_name(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_settings_sidebar_get_visible_child_name(self.as_ref().to_glib_none().0))
        }
    }

    fn set_visible_child_name(&self, value: Option<&str>) {
        unsafe {
            ffi::granite_settings_sidebar_set_visible_child_name(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn connect_visible_child_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_visible_child_name_trampoline<P: IsA<SettingsSidebar>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteSettingsSidebar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::visible-child-name\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_visible_child_name_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
