...
glib::wrapper! {
    ...
    pub struct Toast(Object<ffi::GraniteToast, ffi::GraniteToastClass>) @extends gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;

    match fn {
        type_ => || ffi::granite_toast_get_type(),
    }
}
...
impl Toast {
    ...
    #[doc(alias = "granite_toast_new")]
    pub fn new(title: &str) -> Toast {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::granite_toast_new(title.to_glib_none().0))
        }
    }
...
impl<O: IsA<Toast>> ToastExt for O {
    fn title(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_toast_get_title(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_default_action(&self, label: Option<&str>) {
        unsafe {
            ffi::granite_toast_set_default_action(self.as_ref().to_glib_none().0, label.to_glib_none().0);
        }
    }
    ...
    fn connect_closed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn closed_trampoline<P: IsA<Toast>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteToast, f: glib::ffi::gpointer) {
    ...
    fn connect_default_action<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn default_action_trampoline<P: IsA<Toast>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteToast, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Toast::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"default-action\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(default_action_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_title_trampoline<P: IsA<Toast>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteToast, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Toast::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
