...
glib::wrapper! {
    ...
    pub struct Placeholder(Object<ffi::GranitePlaceholder, ffi::GranitePlaceholderClass>) @extends gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;

    match fn {
        type_ => || ffi::granite_placeholder_get_type(),
    }
}

impl Placeholder {
        pub const NONE: Option<&'static Placeholder> = None;
    

    #[doc(alias = "granite_placeholder_new")]
    pub fn new(title: &str) -> Placeholder {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::granite_placeholder_new(title.to_glib_none().0))
        }
    }

            // rustdoc-stripper-ignore-next
            /// Creates a new builder-pattern struct instance to construct [`Placeholder`] objects.
            ///
            /// This method returns an instance of [`PlaceholderBuilder`](crate::builders::PlaceholderBuilder) which can be used to create [`Placeholder`] objects.
...
// rustdoc-stripper-ignore-next
        /// A [builder-pattern] type to construct [`Placeholder`] objects.
        ///
        /// [builder-pattern]: https://doc.rust-lang.org/1.0.0/style/ownership/builders.html
#[must_use = "The builder must be built to be used"]
pub struct PlaceholderBuilder {
            builder: glib::object::ObjectBuilder<'static, Placeholder>,
        }
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("icon", icon.clone().upcast()), }
                        }
...
pub trait PlaceholderExt: 'static {
    ...
    fn append_button(&self, icon: &impl IsA<gio::Icon>, label: &str, description: &str) -> Option<gtk::Button>;
...
impl<O: IsA<Placeholder>> PlaceholderExt for O {
    fn title(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_placeholder_get_title(self.as_ref().to_glib_none().0))
        }
    }

    fn set_title(&self, value: &str) {
        unsafe {
            ffi::granite_placeholder_set_title(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn description(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_placeholder_get_description(self.as_ref().to_glib_none().0))
        }
    }

    fn set_description(&self, value: &str) {
        unsafe {
            ffi::granite_placeholder_set_description(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn icon(&self) -> Option<gio::Icon> {
        unsafe {
            from_glib_none(ffi::granite_placeholder_get_icon(self.as_ref().to_glib_none().0))
        }
    }

    fn set_icon(&self, value: &impl IsA<gio::Icon>) {
        unsafe {
            ffi::granite_placeholder_set_icon(self.as_ref().to_glib_none().0, value.as_ref().to_glib_none().0);
        }
    }

    fn append_button(&self, icon: &impl IsA<gio::Icon>, label: &str, description: &str) -> Option<gtk::Button> {
        unsafe {
            from_glib_full(ffi::granite_placeholder_append_button(self.as_ref().to_glib_none().0, icon.as_ref().to_glib_none().0, label.to_glib_none().0, description.to_glib_none().0))
        }
    }

    fn connect_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_title_trampoline<P: IsA<Placeholder>, F: Fn(&P) + 'static>(this: *mut ffi::GranitePlaceholder, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Placeholder::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_description_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_description_trampoline<P: IsA<Placeholder>, F: Fn(&P) + 'static>(this: *mut ffi::GranitePlaceholder, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Placeholder::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_icon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_icon_trampoline<P: IsA<Placeholder>, F: Fn(&P) + 'static>(this: *mut ffi::GranitePlaceholder, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Placeholder::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
