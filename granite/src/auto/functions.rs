...
pub fn date_time_get_default_time_format(is_12h: bool, with_second: bool) -> Option<glib::GString> {
    ...
    unsafe {
        from_glib_full(ffi::granite_date_time_get_default_time_format(is_12h.into_glib(), with_second.into_glib()))
    }
}
...
pub fn date_time_get_relative_datetime(date_time: &glib::DateTime) -> Option<glib::GString> {
    assert_initialized_main_thread!();
    unsafe {
        from_glib_full(ffi::granite_date_time_get_relative_datetime(date_time.to_glib_none().0))
    }
}
...
pub fn date_time_is_same_day(day1: &glib::DateTime, day2: &glib::DateTime) -> bool {
    assert_initialized_main_thread!();
    unsafe {
        from_glib(ffi::granite_date_time_is_same_day(day1.to_glib_none().0, day2.to_glib_none().0))
    }
}

#[doc(alias = "granite_date_time_get_default_date_format")]
pub fn date_time_get_default_date_format(with_weekday: bool, with_day: bool, with_year: bool) -> Option<glib::GString> {
    assert_initialized_main_thread!();
    unsafe {
        from_glib_full(ffi::granite_date_time_get_default_date_format(with_weekday.into_glib(), with_day.into_glib(), with_year.into_glib()))
    }
}
...
pub fn date_time_seconds_to_time(seconds: i32) -> Option<glib::GString> {
    assert_initialized_main_thread!();
    unsafe {
        from_glib_full(ffi::granite_date_time_seconds_to_time(seconds))
    }
}
...
pub fn widgets_utils_set_color_primary(window: &impl IsA<gtk::Widget>, color: &mut gdk::RGBA, priority: i32) -> Option<gtk::CssProvider> {
    assert_initialized_main_thread!();
    unsafe {
        from_glib_full(ffi::granite_widgets_utils_set_color_primary(window.as_ref().to_glib_none().0, color.to_glib_none_mut().0, priority))
    }
}
...
pub fn accel_to_string(accel: Option<&str>) -> Option<glib::GString> {
    assert_initialized_main_thread!();
    unsafe {
        from_glib_full(ffi::granite_accel_to_string(accel.to_glib_none().0))
    }
}
...
pub fn markup_accel_tooltip(accels: &[&str], description: Option<&str>) -> Option<glib::GString> {
    ...
    unsafe {
        from_glib_full(ffi::granite_markup_accel_tooltip(accels.to_glib_none().0, accels_length1, description.to_glib_none().0))
    }
}
...
pub fn contrasting_foreground_color(bg_color: &mut gdk::RGBA) -> gdk::RGBA {
    ...
    unsafe {
        ...
        ffi::granite_contrasting_foreground_color(bg_color.to_glib_none_mut().0, result.to_glib_none_mut().0);
        result
    }
}
