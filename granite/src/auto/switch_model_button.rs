...
impl SwitchModelButton {
    ...
    pub fn new(text: &str) -> SwitchModelButton {
        ...
        unsafe {
            from_glib_none(ffi::granite_switch_model_button_new(text.to_glib_none().0))
        }
    }
...
pub struct SwitchModelButtonBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("group", group.clone().upcast()), }
                        }
...
impl<O: IsA<SwitchModelButton>> SwitchModelButtonExt for O {
    fn text(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_switch_model_button_get_text(self.as_ref().to_glib_none().0))
        }
    }

    fn set_text(&self, value: &str) {
        unsafe {
            ffi::granite_switch_model_button_set_text(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn description(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_switch_model_button_get_description(self.as_ref().to_glib_none().0))
        }
    }

    fn set_description(&self, value: Option<&str>) {
        unsafe {
            ffi::granite_switch_model_button_set_description(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn connect_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_text_trampoline<P: IsA<SwitchModelButton>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteSwitchModelButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_description_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_description_trampoline<P: IsA<SwitchModelButton>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteSwitchModelButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SwitchModelButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
