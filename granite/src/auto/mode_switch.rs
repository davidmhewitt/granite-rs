...
impl ModeSwitch {
    ...
    pub fn new(primary_icon_gicon: &impl IsA<gio::Icon>, secondary_icon_gicon: &impl IsA<gio::Icon>) -> ModeSwitch {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::granite_mode_switch_new(primary_icon_gicon.as_ref().to_glib_none().0, secondary_icon_gicon.as_ref().to_glib_none().0))
        }
    }
    ...
    pub fn from_icon_name(primary_icon_name: &str, secondary_icon_name: &str) -> ModeSwitch {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::granite_mode_switch_new_from_icon_name(primary_icon_name.to_glib_none().0, secondary_icon_name.to_glib_none().0))
        }
    }
...
impl<O: IsA<ModeSwitch>> ModeSwitchExt for O {
    fn is_active(&self) -> bool {
        unsafe {
            from_glib(ffi::granite_mode_switch_get_active(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn primary_icon_gicon(&self) -> Option<gio::Icon> {
        unsafe {
            from_glib_none(ffi::granite_mode_switch_get_primary_icon_gicon(self.as_ref().to_glib_none().0))
        }
    }

    fn set_primary_icon_gicon(&self, value: &impl IsA<gio::Icon>) {
        unsafe {
            ffi::granite_mode_switch_set_primary_icon_gicon(self.as_ref().to_glib_none().0, value.as_ref().to_glib_none().0);
        }
    }

    fn primary_icon_name(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_mode_switch_get_primary_icon_name(self.as_ref().to_glib_none().0))
        }
    }

    fn set_primary_icon_name(&self, value: &str) {
        unsafe {
            ffi::granite_mode_switch_set_primary_icon_name(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn primary_icon_tooltip_text(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_mode_switch_get_primary_icon_tooltip_text(self.as_ref().to_glib_none().0))
        }
    }

    fn set_primary_icon_tooltip_text(&self, value: &str) {
        unsafe {
            ffi::granite_mode_switch_set_primary_icon_tooltip_text(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn secondary_icon_gicon(&self) -> Option<gio::Icon> {
        unsafe {
            from_glib_none(ffi::granite_mode_switch_get_secondary_icon_gicon(self.as_ref().to_glib_none().0))
        }
    }

    fn set_secondary_icon_gicon(&self, value: &impl IsA<gio::Icon>) {
        unsafe {
            ffi::granite_mode_switch_set_secondary_icon_gicon(self.as_ref().to_glib_none().0, value.as_ref().to_glib_none().0);
        }
    }

    fn secondary_icon_name(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_mode_switch_get_secondary_icon_name(self.as_ref().to_glib_none().0))
        }
    }

    fn set_secondary_icon_name(&self, value: &str) {
        unsafe {
            ffi::granite_mode_switch_set_secondary_icon_name(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn secondary_icon_tooltip_text(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_mode_switch_get_secondary_icon_tooltip_text(self.as_ref().to_glib_none().0))
        }
    }

    fn set_secondary_icon_tooltip_text(&self, value: &str) {
        unsafe {
            ffi::granite_mode_switch_set_secondary_icon_tooltip_text(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn connect_active_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_active_trampoline<P: IsA<ModeSwitch>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteModeSwitch, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::active\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_active_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_primary_icon_gicon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_primary_icon_gicon_trampoline<P: IsA<ModeSwitch>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteModeSwitch, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ModeSwitch::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::primary-icon-gicon\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_primary_icon_gicon_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_primary_icon_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_primary_icon_name_trampoline<P: IsA<ModeSwitch>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteModeSwitch, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ModeSwitch::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::primary-icon-name\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_primary_icon_name_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_primary_icon_tooltip_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_primary_icon_tooltip_text_trampoline<P: IsA<ModeSwitch>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteModeSwitch, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ModeSwitch::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::primary-icon-tooltip-text\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_primary_icon_tooltip_text_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_secondary_icon_gicon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_secondary_icon_gicon_trampoline<P: IsA<ModeSwitch>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteModeSwitch, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ModeSwitch::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::secondary-icon-gicon\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_secondary_icon_gicon_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_secondary_icon_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_secondary_icon_name_trampoline<P: IsA<ModeSwitch>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteModeSwitch, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ModeSwitch::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::secondary-icon-name\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_secondary_icon_name_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_secondary_icon_tooltip_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_secondary_icon_tooltip_text_trampoline<P: IsA<ModeSwitch>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteModeSwitch, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ModeSwitch::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::secondary-icon-tooltip-text\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_secondary_icon_tooltip_text_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
