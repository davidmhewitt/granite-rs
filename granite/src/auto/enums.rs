...
impl fmt::Display for ServicesContractorError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "ServicesContractorError::{}", match *self {
...
match self {
            Self::ServiceNotAvailable => ffi::GRANITE_SERVICES_CONTRACTOR_ERROR_SERVICE_NOT_AVAILABLE,
...
match value {
            ffi::GRANITE_SERVICES_CONTRACTOR_ERROR_SERVICE_NOT_AVAILABLE => Self::ServiceNotAvailable,
...
impl ErrorDomain for ServicesContractorError {
    ...
    fn domain() -> Quark {
        ...
        static QUARK: once_cell::sync::Lazy<glib::ffi::GQuark> = once_cell::sync::Lazy::new(|| unsafe {
            glib::ffi::g_quark_from_static_string(b"granite-services-contractor-error-quark\0".as_ptr() as *const _)
        });
...
impl fmt::Display for SettingsColorScheme {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "SettingsColorScheme::{}", match *self {
...
impl fmt::Display for SettingsPageStatusType {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "SettingsPageStatusType::{}", match *self {
            Self::Error => "Error",
