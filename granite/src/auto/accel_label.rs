...
impl AccelLabel {
    ...
    pub fn new(label: &str, accel_string: Option<&str>) -> AccelLabel {
        ...
        unsafe {
            from_glib_none(ffi::granite_accel_label_new(label.to_glib_none().0, accel_string.to_glib_none().0))
        }
    }
    ...
    pub fn from_action_name(label: &str, action_name: &str) -> AccelLabel {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::granite_accel_label_new_from_action_name(label.to_glib_none().0, action_name.to_glib_none().0))
        }
    }
...
pub struct AccelLabelBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("accel-string", accel_string.into()), }
                        }
...
impl<O: IsA<AccelLabel>> AccelLabelExt for O {
    fn action_name(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_accel_label_get_action_name(self.as_ref().to_glib_none().0))
        }
    }

    fn set_action_name(&self, value: &str) {
        unsafe {
            ffi::granite_accel_label_set_action_name(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn accel_string(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_accel_label_get_accel_string(self.as_ref().to_glib_none().0))
        }
    }

    fn set_accel_string(&self, value: Option<&str>) {
        unsafe {
            ffi::granite_accel_label_set_accel_string(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn label(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_accel_label_get_label(self.as_ref().to_glib_none().0))
        }
    }

    fn set_label(&self, value: &str) {
        unsafe {
            ffi::granite_accel_label_set_label(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn connect_action_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_action_name_trampoline<P: IsA<AccelLabel>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteAccelLabel, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::action-name\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_action_name_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_accel_string_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accel_string_trampoline<P: IsA<AccelLabel>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteAccelLabel, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AccelLabel::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::accel-string\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_accel_string_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_label_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_label_trampoline<P: IsA<AccelLabel>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteAccelLabel, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AccelLabel::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
