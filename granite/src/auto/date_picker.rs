...
impl DatePicker {
    ...
    pub fn with_format(format: &str) -> DatePicker {
        ...
        unsafe {
            from_glib_none(ffi::granite_date_picker_new_with_format(format.to_glib_none().0))
        }
    }
    ...
    pub fn new() -> DatePicker {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::granite_date_picker_new())
        }
    }
...
pub struct DatePickerBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("date", date.clone()), }
                        }
...
impl<O: IsA<DatePicker>> DatePickerExt for O {
    fn format(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_date_picker_get_format(self.as_ref().to_glib_none().0))
        }
    }

    fn date(&self) -> Option<glib::DateTime> {
        unsafe {
            from_glib_none(ffi::granite_date_picker_get_date(self.as_ref().to_glib_none().0))
        }
    }

    fn set_date(&self, value: &glib::DateTime) {
        unsafe {
            ffi::granite_date_picker_set_date(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn connect_date_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_date_trampoline<P: IsA<DatePicker>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteDatePicker, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(DatePicker::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::date\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_date_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
