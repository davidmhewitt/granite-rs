...
impl DrawingBufferSurface {
    ...
    pub fn new(width: i32, height: i32) -> DrawingBufferSurface {
        ...
        unsafe {
            from_glib_full(ffi::granite_drawing_buffer_surface_new(width, height))
        }
    }

    #[doc(alias = "granite_drawing_buffer_surface_new_with_buffer_surface")]
    pub fn with_buffer_surface(width: i32, height: i32, model: &impl IsA<DrawingBufferSurface>) -> DrawingBufferSurface {
        skip_assert_initialized!();
        unsafe {
            from_glib_full(ffi::granite_drawing_buffer_surface_new_with_buffer_surface(width, height, model.as_ref().to_glib_none().0))
        }
    }
...
impl<O: IsA<DrawingBufferSurface>> DrawingBufferSurfaceExt for O {
    fn surface(&self) -> Option<cairo::Surface> {
        unsafe {
            from_glib_none(ffi::granite_drawing_buffer_surface_get_surface(self.as_ref().to_glib_none().0))
        }
    }

    fn width(&self) -> i32 {
        unsafe {
            ffi::granite_drawing_buffer_surface_get_width(self.as_ref().to_glib_none().0)
        }
    }

    fn height(&self) -> i32 {
        unsafe {
            ffi::granite_drawing_buffer_surface_get_height(self.as_ref().to_glib_none().0)
        }
    }

    fn context(&self) -> Option<cairo::Context> {
        unsafe {
            from_glib_none(ffi::granite_drawing_buffer_surface_get_context(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn load_to_pixbuf(&self) -> Option<gdk_pixbuf::Pixbuf> {
        unsafe {
            from_glib_full(ffi::granite_drawing_buffer_surface_load_to_pixbuf(self.as_ref().to_glib_none().0))
        }
    }

    fn average_color(&self) -> Option<DrawingColor> {
        unsafe {
            from_glib_full(ffi::granite_drawing_buffer_surface_average_color(self.as_ref().to_glib_none().0))
        }
    }

    fn fast_blur(&self, radius: i32, process_count: i32) {
        unsafe {
            ffi::granite_drawing_buffer_surface_fast_blur(self.as_ref().to_glib_none().0, radius, process_count);
        }
    }

    fn exponential_blur(&self, radius: i32) {
        unsafe {
            ffi::granite_drawing_buffer_surface_exponential_blur(self.as_ref().to_glib_none().0, radius);
        }
    }

    fn gaussian_blur(&self, radius: i32) {
        unsafe {
            ffi::granite_drawing_buffer_surface_gaussian_blur(self.as_ref().to_glib_none().0, radius);
        }
    }
    ...
    fn connect_surface_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_surface_trampoline<P: IsA<DrawingBufferSurface>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteDrawingBufferSurface, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::surface\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_surface_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_width_trampoline<P: IsA<DrawingBufferSurface>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteDrawingBufferSurface, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(DrawingBufferSurface::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_height_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_height_trampoline<P: IsA<DrawingBufferSurface>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteDrawingBufferSurface, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(DrawingBufferSurface::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_context_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_context_trampoline<P: IsA<DrawingBufferSurface>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteDrawingBufferSurface, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(DrawingBufferSurface::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::context\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_context_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
