...
glib::wrapper! {
    #[doc(alias = "GraniteBin")]
    pub struct Bin(Object<ffi::GraniteBin, ffi::GraniteBinClass>) @extends gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;

    match fn {
        type_ => || ffi::granite_bin_get_type(),
    }
}
...
impl Bin {
    ...
    #[doc(alias = "granite_bin_new")]
    pub fn new() -> Bin {
        assert_initialized_main_thread!();
        unsafe { from_glib_none(ffi::granite_bin_new()) }
    }
...
pub trait BinExt: IsA<Bin> + 'static {
    #[doc(alias = "granite_bin_get_child")]
    #[doc(alias = "get_child")]
    fn child(&self) -> Option<gtk::Widget> {
        unsafe { from_glib_none(ffi::granite_bin_get_child(self.as_ref().to_glib_none().0)) }
    }

    #[doc(alias = "granite_bin_set_child")]
    fn set_child(&self, value: Option<&impl IsA<gtk::Widget>>) {
        unsafe {
            ffi::granite_bin_set_child(
