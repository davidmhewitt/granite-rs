...
use crate::{SettingsPageStatusType};
...
impl<O: IsA<SettingsPage>> SettingsPageExt for O {
    fn status_type(&self) -> SettingsPageStatusType {
        unsafe {
            from_glib(ffi::granite_settings_page_get_status_type(self.as_ref().to_glib_none().0))
        }
    }

    fn set_status_type(&self, value: SettingsPageStatusType) {
        unsafe {
            ffi::granite_settings_page_set_status_type(self.as_ref().to_glib_none().0, value.into_glib());
        }
    }

    fn display_widget(&self) -> Option<gtk::Widget> {
        unsafe {
            from_glib_none(ffi::granite_settings_page_get_display_widget(self.as_ref().to_glib_none().0))
        }
    }

    fn header(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_settings_page_get_header(self.as_ref().to_glib_none().0))
        }
    }

    fn status(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_settings_page_get_status(self.as_ref().to_glib_none().0))
        }
    }

    fn set_status(&self, value: &str) {
        unsafe {
            ffi::granite_settings_page_set_status(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn icon_name(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_settings_page_get_icon_name(self.as_ref().to_glib_none().0))
        }
    }

    fn set_icon_name(&self, value: Option<&str>) {
        unsafe {
            ffi::granite_settings_page_set_icon_name(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn title(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_settings_page_get_title(self.as_ref().to_glib_none().0))
        }
    }

    fn set_title(&self, value: &str) {
        unsafe {
            ffi::granite_settings_page_set_title(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn child(&self) -> Option<gtk::Widget> {
        unsafe {
            from_glib_none(ffi::granite_settings_page_get_child(self.as_ref().to_glib_none().0))
        }
    }

    fn set_child(&self, value: &impl IsA<gtk::Widget>) {
        unsafe {
            ffi::granite_settings_page_set_child(self.as_ref().to_glib_none().0, value.as_ref().to_glib_none().0);
        }
    }

    fn connect_status_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_status_type_trampoline<P: IsA<SettingsPage>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteSettingsPage, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SettingsPage::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::status-type\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_status_type_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_status_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_status_trampoline<P: IsA<SettingsPage>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteSettingsPage, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SettingsPage::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_icon_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_icon_name_trampoline<P: IsA<SettingsPage>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteSettingsPage, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SettingsPage::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_title_trampoline<P: IsA<SettingsPage>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteSettingsPage, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SettingsPage::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_child_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_child_trampoline<P: IsA<SettingsPage>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteSettingsPage, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SettingsPage::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
