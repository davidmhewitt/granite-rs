...
impl TimePicker {
    ...
    pub fn with_format(format_12: &str, format_24: &str) -> TimePicker {
        ...
        unsafe {
            from_glib_none(ffi::granite_time_picker_new_with_format(format_12.to_glib_none().0, format_24.to_glib_none().0))
        }
    }
    ...
    pub fn new() -> TimePicker {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::granite_time_picker_new())
        }
    }
...
pub struct TimePickerBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("format-12", format_12.into()), }
                        }

                            pub fn format_24(self, format_24: impl Into<glib::GString>) -> Self {
                            Self { builder: self.builder.property("format-24", format_24.into()), }
                        }

                            pub fn time(self, time: &glib::DateTime) -> Self {
                            Self { builder: self.builder.property("time", time.clone()), }
                        }
                        ...
                        //}
                            ...
                            Self { builder: self.builder.property("enable-undo", enable_undo), }
                        }
...
impl<O: IsA<TimePicker>> TimePickerExt for O {
    fn format_12(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_time_picker_get_format_12(self.as_ref().to_glib_none().0))
        }
    }

    fn format_24(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_time_picker_get_format_24(self.as_ref().to_glib_none().0))
        }
    }

    fn time(&self) -> Option<glib::DateTime> {
        unsafe {
            from_glib_none(ffi::granite_time_picker_get_time(self.as_ref().to_glib_none().0))
        }
    }

    fn set_time(&self, value: &glib::DateTime) {
        unsafe {
            ffi::granite_time_picker_set_time(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn connect_time_changed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn time_changed_trampoline<P: IsA<TimePicker>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteTimePicker, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(TimePicker::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"time-changed\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(time_changed_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_time_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_time_trampoline<P: IsA<TimePicker>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteTimePicker, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(TimePicker::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::time\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_time_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
