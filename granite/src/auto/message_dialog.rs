...
impl MessageDialog {
    ...
    pub fn new(primary_text: &str, secondary_text: &str, image_icon: &impl IsA<gio::Icon>, buttons: gtk::ButtonsType) -> MessageDialog {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::granite_message_dialog_new(primary_text.to_glib_none().0, secondary_text.to_glib_none().0, image_icon.as_ref().to_glib_none().0, buttons.into_glib()))
        }
    }

    #[doc(alias = "granite_message_dialog_new_with_image_from_icon_name")]
    pub fn with_image_from_icon_name(primary_text: &str, secondary_text: &str, image_icon_name: &str, buttons: gtk::ButtonsType) -> MessageDialog {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::granite_message_dialog_new_with_image_from_icon_name(primary_text.to_glib_none().0, secondary_text.to_glib_none().0, image_icon_name.to_glib_none().0, buttons.into_glib()))
        }
    }
...
pub struct MessageDialogBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("primary-text", primary_text.into()), }
                        }

                            pub fn secondary_text(self, secondary_text: impl Into<glib::GString>) -> Self {
                            Self { builder: self.builder.property("secondary-text", secondary_text.into()), }
                        }

                            pub fn image_icon(self, image_icon: &impl IsA<gio::Icon>) -> Self {
                            Self { builder: self.builder.property("image-icon", image_icon.clone().upcast()), }
                        }

                            pub fn badge_icon(self, badge_icon: &impl IsA<gio::Icon>) -> Self {
                            Self { builder: self.builder.property("badge-icon", badge_icon.clone().upcast()), }
                        }

                            pub fn primary_label(self, primary_label: &gtk::Label) -> Self {
                            Self { builder: self.builder.property("primary-label", primary_label.clone()), }
                        }

                            pub fn secondary_label(self, secondary_label: &gtk::Label) -> Self {
                            Self { builder: self.builder.property("secondary-label", secondary_label.clone()), }
                        }

                            pub fn buttons(self, buttons: gtk::ButtonsType) -> Self {
                            Self { builder: self.builder.property("buttons", buttons), }
                        }

                            pub fn custom_bin(self, custom_bin: &impl IsA<gtk::Box>) -> Self {
                            Self { builder: self.builder.property("custom-bin", custom_bin.clone().upcast()), }
                        }
...
impl<O: IsA<MessageDialog>> MessageDialogExt for O {
    fn primary_text(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_message_dialog_get_primary_text(self.as_ref().to_glib_none().0))
        }
    }

    fn set_primary_text(&self, value: &str) {
        unsafe {
            ffi::granite_message_dialog_set_primary_text(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn secondary_text(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_message_dialog_get_secondary_text(self.as_ref().to_glib_none().0))
        }
    }

    fn set_secondary_text(&self, value: &str) {
        unsafe {
            ffi::granite_message_dialog_set_secondary_text(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn image_icon(&self) -> Option<gio::Icon> {
        unsafe {
            from_glib_full(ffi::granite_message_dialog_get_image_icon(self.as_ref().to_glib_none().0))
        }
    }

    fn set_image_icon(&self, value: &impl IsA<gio::Icon>) {
        unsafe {
            ffi::granite_message_dialog_set_image_icon(self.as_ref().to_glib_none().0, value.as_ref().to_glib_none().0);
        }
    }

    fn badge_icon(&self) -> Option<gio::Icon> {
        unsafe {
            from_glib_full(ffi::granite_message_dialog_get_badge_icon(self.as_ref().to_glib_none().0))
        }
    }

    fn set_badge_icon(&self, value: &impl IsA<gio::Icon>) {
        unsafe {
            ffi::granite_message_dialog_set_badge_icon(self.as_ref().to_glib_none().0, value.as_ref().to_glib_none().0);
        }
    }

    fn primary_label(&self) -> Option<gtk::Label> {
        unsafe {
            from_glib_none(ffi::granite_message_dialog_get_primary_label(self.as_ref().to_glib_none().0))
        }
    }

    fn secondary_label(&self) -> Option<gtk::Label> {
        unsafe {
            from_glib_none(ffi::granite_message_dialog_get_secondary_label(self.as_ref().to_glib_none().0))
        }
    }

    fn custom_bin(&self) -> Option<gtk::Box> {
        unsafe {
            from_glib_none(ffi::granite_message_dialog_get_custom_bin(self.as_ref().to_glib_none().0))
        }
    }

    fn show_error_details(&self, error_message: &str) {
        unsafe {
            ffi::granite_message_dialog_show_error_details(self.as_ref().to_glib_none().0, error_message.to_glib_none().0);
        }
    }

    fn connect_primary_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_primary_text_trampoline<P: IsA<MessageDialog>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteMessageDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(MessageDialog::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::primary-text\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_primary_text_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_secondary_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_secondary_text_trampoline<P: IsA<MessageDialog>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteMessageDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(MessageDialog::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::secondary-text\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_secondary_text_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_image_icon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_image_icon_trampoline<P: IsA<MessageDialog>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteMessageDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(MessageDialog::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::image-icon\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_image_icon_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_badge_icon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_badge_icon_trampoline<P: IsA<MessageDialog>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteMessageDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(MessageDialog::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::badge-icon\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_badge_icon_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
