...
impl<O: IsA<SimpleSettingsPage>> SimpleSettingsPageExt for O {
    fn action_area(&self) -> Option<gtk::Box> {
        unsafe {
            from_glib_none(ffi::granite_simple_settings_page_get_action_area(self.as_ref().to_glib_none().0))
        }
    }

    fn content_area(&self) -> Option<gtk::Grid> {
        unsafe {
            from_glib_none(ffi::granite_simple_settings_page_get_content_area(self.as_ref().to_glib_none().0))
        }
    }

    fn status_switch(&self) -> Option<gtk::Switch> {
        unsafe {
            from_glib_none(ffi::granite_simple_settings_page_get_status_switch(self.as_ref().to_glib_none().0))
        }
    }

    fn is_activatable(&self) -> bool {
        unsafe {
            from_glib(ffi::granite_simple_settings_page_get_activatable(self.as_ref().to_glib_none().0))
        }
    }

    fn description(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_simple_settings_page_get_description(self.as_ref().to_glib_none().0))
        }
    }

    fn set_description(&self, value: &str) {
        unsafe {
            ffi::granite_simple_settings_page_set_description(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn connect_description_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_description_trampoline<P: IsA<SimpleSettingsPage>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteSimpleSettingsPage, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
