...
impl OverlayBar {
    ...
    pub fn new(overlay: Option<&gtk::Overlay>) -> OverlayBar {
        ...
        unsafe {
            from_glib_none(ffi::granite_overlay_bar_new(overlay.to_glib_none().0))
        }
    }
...
pub struct OverlayBarBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("overlay", overlay.clone()), }
                        }
...
impl<O: IsA<OverlayBar>> OverlayBarExt for O {
    fn overlay(&self) -> Option<gtk::Overlay> {
        unsafe {
            from_glib_none(ffi::granite_overlay_bar_get_overlay(self.as_ref().to_glib_none().0))
        }
    }

    fn label(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::granite_overlay_bar_get_label(self.as_ref().to_glib_none().0))
        }
    }

    fn set_label(&self, value: &str) {
        unsafe {
            ffi::granite_overlay_bar_set_label(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn is_active(&self) -> bool {
        unsafe {
            from_glib(ffi::granite_overlay_bar_get_active(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_label_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_label_trampoline<P: IsA<OverlayBar>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteOverlayBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_active_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_active_trampoline<P: IsA<OverlayBar>, F: Fn(&P) + 'static>(this: *mut ffi::GraniteOverlayBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(OverlayBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
