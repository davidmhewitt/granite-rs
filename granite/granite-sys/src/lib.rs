...
pub const GRANITE_TOOLTIP_SECONDARY_TEXT_MARKUP: &[u8] = b"<span weight=\"600\" size=\"smaller\" alpha=\"75%\">%s</span>\0";
...
impl ::std::fmt::Debug for GraniteServicesSettingsSerializableIface {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GraniteServicesSettingsSerializableIface @ {self:p}"))
...
impl ::std::fmt::Debug for GraniteToast {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GraniteToast @ {self:p}"))
         .finish()
    }
}
...
extern "C" {
    ...
    pub fn granite_accel_label_set_accel_string(self_: *mut GraniteAccelLabel, value: *const c_char);
    ...
    pub fn granite_drawing_buffer_surface_get_surface(self_: *mut GraniteDrawingBufferSurface) -> *mut cairo::cairo_surface_t;
    pub fn granite_drawing_buffer_surface_get_width(self_: *mut GraniteDrawingBufferSurface) -> c_int;
    pub fn granite_drawing_buffer_surface_get_height(self_: *mut GraniteDrawingBufferSurface) -> c_int;
    pub fn granite_drawing_buffer_surface_get_context(self_: *mut GraniteDrawingBufferSurface) -> *mut cairo::cairo_t;
    ...
    pub fn granite_drawing_buffer_surface_load_to_pixbuf(self_: *mut GraniteDrawingBufferSurface) -> *mut gdk_pixbuf::GdkPixbuf;
    pub fn granite_drawing_buffer_surface_average_color(self_: *mut GraniteDrawingBufferSurface) -> *mut GraniteDrawingColor;
    pub fn granite_drawing_buffer_surface_fast_blur(self_: *mut GraniteDrawingBufferSurface, radius: c_int, process_count: c_int);
    pub fn granite_drawing_buffer_surface_exponential_blur(self_: *mut GraniteDrawingBufferSurface, radius: c_int);
    pub fn granite_drawing_buffer_surface_gaussian_blur(self_: *mut GraniteDrawingBufferSurface, radius: c_int);
    ...
    pub fn granite_drawing_color_new_from_rgba(color: *mut gdk::GdkRGBA) -> *mut GraniteDrawingColor;
    ...
    pub fn granite_drawing_color_set_hue(self_: *mut GraniteDrawingColor, hue: c_double) -> *mut GraniteDrawingColor;
    pub fn granite_drawing_color_set_sat(self_: *mut GraniteDrawingColor, sat: c_double) -> *mut GraniteDrawingColor;
    pub fn granite_drawing_color_set_val(self_: *mut GraniteDrawingColor, val: c_double) -> *mut GraniteDrawingColor;
    pub fn granite_drawing_color_set_alpha(self_: *mut GraniteDrawingColor, alpha: c_double) -> *mut GraniteDrawingColor;
    ...
    pub fn granite_drawing_color_add_hue(self_: *mut GraniteDrawingColor, val: c_double) -> *mut GraniteDrawingColor;
    pub fn granite_drawing_color_set_min_sat(self_: *mut GraniteDrawingColor, sat: c_double) -> *mut GraniteDrawingColor;
    pub fn granite_drawing_color_set_min_value(self_: *mut GraniteDrawingColor, val: c_double) -> *mut GraniteDrawingColor;
    pub fn granite_drawing_color_set_max_sat(self_: *mut GraniteDrawingColor, sat: c_double) -> *mut GraniteDrawingColor;
    pub fn granite_drawing_color_set_max_val(self_: *mut GraniteDrawingColor, val: c_double) -> *mut GraniteDrawingColor;
    pub fn granite_drawing_color_multiply_sat(self_: *mut GraniteDrawingColor, amount: c_double) -> *mut GraniteDrawingColor;
    pub fn granite_drawing_color_brighten_val(self_: *mut GraniteDrawingColor, amount: c_double) -> *mut GraniteDrawingColor;
    pub fn granite_drawing_color_darken_val(self_: *mut GraniteDrawingColor, amount: c_double) -> *mut GraniteDrawingColor;
    pub fn granite_drawing_color_darken_by_sat(self_: *mut GraniteDrawingColor, amount: c_double) -> *mut GraniteDrawingColor;
    ...
    pub fn granite_message_dialog_get_primary_text(self_: *mut GraniteMessageDialog) -> *const c_char;
    pub fn granite_message_dialog_set_primary_text(self_: *mut GraniteMessageDialog, value: *const c_char);
    pub fn granite_message_dialog_get_secondary_text(self_: *mut GraniteMessageDialog) -> *const c_char;
    pub fn granite_message_dialog_set_secondary_text(self_: *mut GraniteMessageDialog, value: *const c_char);
    pub fn granite_message_dialog_get_image_icon(self_: *mut GraniteMessageDialog) -> *mut gio::GIcon;
    pub fn granite_message_dialog_set_image_icon(self_: *mut GraniteMessageDialog, value: *mut gio::GIcon);
    pub fn granite_message_dialog_get_badge_icon(self_: *mut GraniteMessageDialog) -> *mut gio::GIcon;
    pub fn granite_message_dialog_set_badge_icon(self_: *mut GraniteMessageDialog, value: *mut gio::GIcon);
    pub fn granite_message_dialog_get_primary_label(self_: *mut GraniteMessageDialog) -> *mut gtk::GtkLabel;
    pub fn granite_message_dialog_get_secondary_label(self_: *mut GraniteMessageDialog) -> *mut gtk::GtkLabel;
    pub fn granite_message_dialog_get_custom_bin(self_: *mut GraniteMessageDialog) -> *mut gtk::GtkBox;
    ...
    pub fn granite_message_dialog_show_error_details(self_: *mut GraniteMessageDialog, error_message: *const c_char);
    ...
    pub fn granite_mode_switch_get_primary_icon_gicon(self_: *mut GraniteModeSwitch) -> *mut gio::GIcon;
    pub fn granite_mode_switch_set_primary_icon_gicon(self_: *mut GraniteModeSwitch, value: *mut gio::GIcon);
    pub fn granite_mode_switch_get_primary_icon_name(self_: *mut GraniteModeSwitch) -> *const c_char;
    pub fn granite_mode_switch_set_primary_icon_name(self_: *mut GraniteModeSwitch, value: *const c_char);
    pub fn granite_mode_switch_get_primary_icon_tooltip_text(self_: *mut GraniteModeSwitch) -> *const c_char;
    pub fn granite_mode_switch_set_primary_icon_tooltip_text(self_: *mut GraniteModeSwitch, value: *const c_char);
    pub fn granite_mode_switch_get_secondary_icon_gicon(self_: *mut GraniteModeSwitch) -> *mut gio::GIcon;
    pub fn granite_mode_switch_set_secondary_icon_gicon(self_: *mut GraniteModeSwitch, value: *mut gio::GIcon);
    pub fn granite_mode_switch_get_secondary_icon_name(self_: *mut GraniteModeSwitch) -> *const c_char;
    pub fn granite_mode_switch_set_secondary_icon_name(self_: *mut GraniteModeSwitch, value: *const c_char);
    pub fn granite_mode_switch_get_secondary_icon_tooltip_text(self_: *mut GraniteModeSwitch) -> *const c_char;
    pub fn granite_mode_switch_set_secondary_icon_tooltip_text(self_: *mut GraniteModeSwitch, value: *const c_char);
    ...
    pub fn granite_placeholder_set_description(self_: *mut GranitePlaceholder, value: *const c_char);
    ...
    pub fn granite_placeholder_append_button(self_: *mut GranitePlaceholder, icon: *mut gio::GIcon, label: *const c_char, description: *const c_char) -> *mut gtk::GtkButton;
    ...
    pub fn granite_settings_get_prefers_color_scheme(self_: *mut GraniteSettings) -> GraniteSettingsColorScheme;
    ...
    pub fn granite_settings_page_get_status_type(self_: *mut GraniteSettingsPage) -> GraniteSettingsPageStatusType;
    pub fn granite_settings_page_set_status_type(self_: *mut GraniteSettingsPage, value: GraniteSettingsPageStatusType);
    pub fn granite_settings_page_get_display_widget(self_: *mut GraniteSettingsPage) -> *mut gtk::GtkWidget;
    ...
    pub fn granite_settings_page_set_icon_name(self_: *mut GraniteSettingsPage, value: *const c_char);
    ...
    pub fn granite_settings_page_set_child(self_: *mut GraniteSettingsPage, value: *mut gtk::GtkWidget);

    //=========================================================================
    // GraniteSettingsSidebar
    //=========================================================================
    pub fn granite_settings_sidebar_get_type() -> GType;
    pub fn granite_settings_sidebar_get_stack(self_: *mut GraniteSettingsSidebar) -> *mut gtk::GtkStack;
    pub fn granite_settings_sidebar_get_visible_child_name(self_: *mut GraniteSettingsSidebar) -> *const c_char;
    pub fn granite_settings_sidebar_set_visible_child_name(self_: *mut GraniteSettingsSidebar, value: *const c_char);
    ...
    pub fn granite_simple_settings_page_get_action_area(self_: *mut GraniteSimpleSettingsPage) -> *mut gtk::GtkBox;
    pub fn granite_simple_settings_page_get_content_area(self_: *mut GraniteSimpleSettingsPage) -> *mut gtk::GtkGrid;
    pub fn granite_simple_settings_page_get_status_switch(self_: *mut GraniteSimpleSettingsPage) -> *mut gtk::GtkSwitch;
    pub fn granite_simple_settings_page_get_activatable(self_: *mut GraniteSimpleSettingsPage) -> gboolean;
    pub fn granite_simple_settings_page_get_description(self_: *mut GraniteSimpleSettingsPage) -> *const c_char;
    pub fn granite_simple_settings_page_set_description(self_: *mut GraniteSimpleSettingsPage, value: *const c_char);

    //=========================================================================
    // GraniteSwitchModelButton
    //=========================================================================
    pub fn granite_switch_model_button_get_type() -> GType;
    pub fn granite_switch_model_button_get_text(self_: *mut GraniteSwitchModelButton) -> *const c_char;
    pub fn granite_switch_model_button_set_text(self_: *mut GraniteSwitchModelButton, value: *const c_char);
    pub fn granite_switch_model_button_get_description(self_: *mut GraniteSwitchModelButton) -> *const c_char;
    pub fn granite_switch_model_button_set_description(self_: *mut GraniteSwitchModelButton, value: *const c_char);
    ...
    pub fn granite_time_picker_new_with_format(format_12: *const c_char, format_24: *const c_char) -> *mut GraniteTimePicker;
    ...
    pub fn granite_validated_entry_get_regex(self_: *mut GraniteValidatedEntry) -> *mut glib::GRegex;
    pub fn granite_validated_entry_set_regex(self_: *mut GraniteValidatedEntry, value: *mut glib::GRegex);
    pub fn granite_validated_entry_new_from_regex(regex_arg: *mut glib::GRegex) -> *mut GraniteValidatedEntry;
    ...
    pub fn granite_services_contract_get_display_name(self_: *mut GraniteServicesContract) -> *mut c_char;
    pub fn granite_services_contract_get_description(self_: *mut GraniteServicesContract) -> *mut c_char;
    pub fn granite_services_contract_get_icon(self_: *mut GraniteServicesContract) -> *mut gio::GIcon;
    pub fn granite_services_contract_execute_with_file(self_: *mut GraniteServicesContract, file: *mut gio::GFile, error: *mut *mut glib::GError);
    pub fn granite_services_contract_execute_with_files(self_: *mut GraniteServicesContract, files: *mut *mut gio::GFile, files_length1: c_int, error: *mut *mut glib::GError);

    //=========================================================================
    // GraniteServicesSettingsSerializable
    //=========================================================================
    pub fn granite_services_settings_serializable_get_type() -> GType;
    pub fn granite_services_settings_serializable_settings_serialize(self_: *mut GraniteServicesSettingsSerializable) -> *mut c_char;
    pub fn granite_services_settings_serializable_settings_deserialize(self_: *mut GraniteServicesSettingsSerializable, s: *const c_char);
    ...
    pub fn granite_widgets_utils_set_color_primary(window: *mut gtk::GtkWidget, color: *mut gdk::GdkRGBA, priority: c_int) -> *mut gtk::GtkCssProvider;
    ...
    pub fn granite_contrasting_foreground_color(bg_color: *mut gdk::GdkRGBA, result: *mut gdk::GdkRGBA);
